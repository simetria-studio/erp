                                    ...
                                    <div class="tab-pane fade show active" id="registroEmpresa-justify" role="tabpanel" aria-labelledby="registroEmpresa-tab-justify">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="corporate_name" value="{{$company->corporate_name}}" required="required" class="form-control" placeholder="Nome a Empresa"  />
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="control-label">Nome Fantasia</label>
                                                <input type="text" name="fantasy_name" value="{{$company->fantasy_name}}" class="form-control" placeholder="Nome Fantasia" />
                                            </div>
                                            <div class="col-md-6 form-group">
                                                ...
                                                <select name="kind_of_person" class="form-control" required="required">
                                                    ...
                                                    <option value="CPF" {{$company->kind_of_person == 'CPF' ? 'selected' : ''}}>CPF</option>
                                                    <option value="CNPJ" {{$company->kind_of_person == 'CNPJ' ? 'selected' : ''}}>CNPJ</option>
                                                    <option value="NIF" {{$company->kind_of_person == 'NIF' ? 'selected' : ''}}>NIF</option>
                                                    <option value="IBAN" {{$company->kind_of_person == 'IBAN' ? 'selected' : ''}}>IBAN</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="document_number" class="control-label">Numero do Documento</label>
                                                <input type="text" class="form-control" value="{{$company->document_number}}" required="required" name="document_number" placeholder="Numero do Documento">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="state_registration" class="control-label">Registro Estadual</label>
                                                <input type="text" class="form-control" value="{{$company->state_registration}}" name="state_registration" placeholder="Numero do Registro">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="municipal_registration" class="control-label">Registro Municipal</label>
                                                <input type="text" class="form-control" value="{{$company->municipal_registration}}" name="municipal_registration" placeholder="Numero do Registro">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="economic_activity" class="control-label">Atividade Economica</label>
                                                <input type="text" class="form-control" value="{{$company->economic_activity}}" required="required" name="economic_activity" placeholder="Atividade Exercida">
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="endereco-justify" role="tabpanel" aria-labelledby="endereco-tab-justify">
                                        <div class="row">
                                            <div class="col-md-3 form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{$company->zip_code}}" required="required" name="zip_code" placeholder="Codigo Postal">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="address" class="control-label">Endereço</label>
                                                <input type="text" class="form-control" value="{{$company->address}}" required="required" name="address" placeholder="Endereço">
                                            </div>
                                            <div class="col-md-3 form-group">
                                                <div class="form-group">
                                                    <label for="number" class="control-label">Nº</label>
                                                    <input type="text" class="form-control" value="{{$company->number}}" required="required" name="number" placeholder="0">
                                                </div>
                                            </div>
                                            <div class="col-md-3 form-group">
                                                <div class="form-group">
                                                    <label for="address2" class="control-label">Bairro</label>
                                                    <input type="text" class="form-control" value="{{$company->address2}}" required="required" name="address2" placeholder="Bairro">
                                                </div>
                                            </div>
                                            <div class="col-md-3 form-group">
                                                <div class="form-group">
                                                    <label for="country" class="control-label">País</label>
                                                    <input type="text" class="form-control" value="{{$company->country}}" required="required" name="country" placeholder="país">
                                                </div>
                                            </div>
                                            <div class="col-md-3 form-group">
                                                <div class="form-group">
                                                    <label for="state" class="control-label">Estado</label>
                                                    <input type="text" class="form-control" value="{{$company->state}}" required="required" name="state" placeholder="Estado">
                                                </div>
                                            </div>
                                            <div class="col-md-3 form-group">
                                                <div class="form-group">
                                                    <label for="city" class="control-label">Cidade</label>
                                                    <input type="text" class="form-control" value="{{$company->city}}" required="required" name="city" placeholder="Cidade">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="contato-justify" role="tabpanel" aria-labelledby="contato-tab-justify">
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" class="form-control" value="{{$company->phone1}}" name="phone1" placeholder="Telefone">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="phone2" class="control-label">Celular</label>
                                                <input type="text" class="form-control" value="{{$company->phone2}}" required="required" name="phone2" placeholder="Celular">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="email" class="control-label">Email de Contato</label>
                                                <input type="email" class="form-control" value="{{$company->email}}" name="email" placeholder="Emal de Contato">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="contact_name" class="control-label">Nome de Contato</label>
                                                <input type="text" class="form-control" value="{{$company->contact_name}}" name="contact_name" placeholder="Nome de Contato">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="http" class="control-label">Site da Empresa</label>
                                                <input type="text" class="form-control" value="{{$company->http}}" name="http" placeholder="Site da Empresa">
                                            </div>
                                        </div>
                                    </div>
                                </div>
